...
def updateItems(table):
    for hr in range(24):
        date_time = f'20201101{hr:02}00'
        new_s3_loc = f's3://dl-pipeline-mart-east1-mod-dev/lld/MD_2203/quality/logs/2020/11/01/{hr:02}/impressions'
        search_key = {
